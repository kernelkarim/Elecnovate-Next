...
const TestimonialCard43 = (props) => {
  return (
    <>
      <div
        className={`testimonial-card43-testimonial-card ${props.rootClassName} `}
      >
        <svg viewBox="0 0 1024 1024" className="testimonial-card43-icon">
        ...
        <span className="testimonial-card43-text">{props.quote}</span>
        <div className="testimonial-card43-profile">
          <img
            alt={props.pictureAlt}
            src={props.pictureSrc}
            className="testimonial-card43-image"
          />
          <div className="testimonial-card43-container">
            <span className="testimonial-card43-text1">{props.name}</span>
            <span className="testimonial-card43-text2">{props.role}</span>
          </div>
        </div>
      </div>
      <style jsx>
        {`
          .testimonial-card43-testimonial-card {
            width: 100%;
            display: flex;
          ...
          .testimonial-card43-icon {
            width: var(--dl-size-size-medium);
            flex-shrink: 0;
            margin-bottom: var(--dl-space-space-halfunit);
          }
          .testimonial-card43-text {
            color: var(--dl-color-gray-500);
            font-size: 1.15rem;
            padding-top: var(--dl-space-space-threeunits);
            padding-bottom: var(--dl-space-space-threeunits);
          }
          .testimonial-card43-profile {
            width: 100%;
            display: flex;
            margin-top: auto;
            align-items: center;
          ...
          .testimonial-card43-text1 {
            font-size: 24px;
            font-style: normal;
            font-weight: 600;
            margin-bottom: 0.25rem;
          }
          .testimonial-card43-text2 {
            color: var(--dl-color-gray-500);
            font-size: 12px;
            font-style: normal;
            font-weight: 600;
...
TestimonialCard43.defaultProps = {
  rootClassName: '',
  name: 'John Doe',
  pictureSrc:
...
export default TestimonialCard43
