    ...
    <>
      ...
      >
        <div className="testimonial-card22-testimonial">
          <svg viewBox="0 0 1024 1024" className="testimonial-card22-icon">
          ...
          <span className="testimonial-card22-text">{props.quote}</span>
          <span className="testimonial-card22-text1">{props.name}</span>
        </div>
        <img
      ...
      <style jsx>
        {`
          ...
          .testimonial-card22-icon {
            width: var(--dl-size-size-small);
            flex-shrink: 0;
            margin-bottom: var(--dl-space-space-twounits);
          }
          .testimonial-card22-text {
          ...
          .testimonial-card22-root-class-name1 {
            align-self: flex-start;
          }
          .testimonial-card22-root-class-name2 {
            align-self: flex-start;
          }
